...
# ADD forces cache invalidation when the remote repo changes
ARG GITHUB_TOKEN=""
ADD https://api.github.com/repos/zhengxuyu/dayTradeDash/git/refs/heads/main /tmp/dash-version.json
